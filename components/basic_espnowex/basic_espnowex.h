...
class OnMessageTrigger : public ::esphome::automation::Trigger<std::vector<uint8_t>, std::array<uint8_t, 6>> {
 public:
  explicit OnMessageTrigger(BasicESPNowEx *parent);
};
class OnRecvAckTrigger : public ::esphome::automation::Trigger<std::array<uint8_t, 6>> {
public:
    explicit OnRecvAckTrigger(BasicESPNowEx *parent);
};
class OnRecvCmdTrigger : public ::esphome::automation::Trigger<std::array<uint8_t, 6>, int16_t> {
public:
